  ...
  render = () => {
    ...
    modalEl.innerHTML = `
        ...
        <div class="flex justify-between items-start p-4 border-b border-gray-200">
          <h2 class="text-xl font-semibold text-gray-700">${this.state.card.title}</h2>
        ...
        <div class="flex flex-col md:flex-row max-h-[calc(100vh-10rem)] overflow-y-auto">
          <div class="flex-grow p-4 space-y-4">
            <div class="flex items-start space-x-4">
              ...
              <textarea class="flex-grow p-2 border rounded-md" rows="3" placeholder="Add a more detailed description...">${this.state.card.description}</textarea>
            </div>
            <div class="flex items-start space-x-4">
              <svg class="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
