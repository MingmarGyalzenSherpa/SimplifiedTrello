...
// export function NavBar(parentEl: HTMLElement) {
//   parentEl.innerHTML += `
//     <nav
//   class=" w-full bg-primary flex   h-[10vh] px-4 py-2 mx-auto text-white  shadow-md   backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
//   <div class="container flex items-center justify-between mx-auto ">
//     <a  data-to="/login"
//       class="navbar__link  mr-4 block  cursor-pointer py-1.5 font-sans  font-bold text-3xl leading-relaxed text-inherit antialiased">
//       Trello
//     </a>
//     <div class="hidden lg:block">
//       <ul class="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
//         <li
//           class="flex items-center p-3   font-sans text-sm antialiased font-medium leading-normal gap-x-2
...
//         </li>
//         <li
//           class="flex items-center transition-all duration-300  ease-in-out  transform hover:bg-gray-700 p-3  font-sans text-sm antialiased font-medium leading-normal gap-x-2 ">
...
//         </li>
//         <li
//           class="flex items-center   p-3 transition-all duration-300  ease-in-out  transform  hover:bg-gray-700  font-sans text-sm antialiased font-medium leading-normal gap-x-2 ">
//           <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
//             <path fill-rule="evenodd" clip-rule="evenodd"
...
//       <button
//         class="hidden px-4 py-2 font-sans text-xs font-bold text-center uppercase align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
//         type="button">
//         <span>Log In</span>
//       </button>
//       <button
...
//     const navLinks =
//       document.querySelectorAll<HTMLAnchorElement>(".navbar__link");
